...
// FIX: Changed import path to explicitly include .ts extension for better module resolution.
// The previous relative path without .ts was causing resolution issues in the build environment.
import { db, collection, addDoc, auth, appId } from '../../../lib/firebase.ts'; // Ensure path is correct and includes .ts
...
// FIX: Changed import path to explicitly include .ts extension for better module resolution.
// The previous relative path without .ts was causing resolution issues in the build environment.
// import { db, collection, addDoc, auth, appId } from '../../../lib/firebase.ts'; // << ลบอันนี้ออก
import { db, collection, addDoc, auth, appId } from '@/lib/firebase'; // << ใช้ alias นี้แทน สวยกว่าเยอะ!
import { onAuthStateChanged } from 'firebase/auth';
